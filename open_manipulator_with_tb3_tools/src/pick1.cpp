...
geometry_msgs::PoseStamped calcDesiredPose(ar_track_alvar_msgs::AlvarMarker marker)
{
  ...
  if (marker.id == get_marker_id)
  {
    ...
    ROS_INFO(".......................................dx = %.3f", get_pose.pose.position.x);
    ROS_INFO(".......................................dy = %.3f", get_pose.pose.position.y);
    ROS_INFO(".......................................dz = %.3f", get_pose.pose.position.z);
...
void pick()
{
  ...
  switch (task)
  {
	...
	desired_pose.pose.position.x = -0.075 ;
	desired_pose.pose.position.y = 0.029 ;
	desired_pose.pose.position.z = 0.236 ;

	desired_pose.pose.orientation.x = -0.066 ;
	desired_pose.pose.orientation.y = 0.078 ;
	desired_pose.pose.orientation.z = 0.641 ;
	desired_pose.pose.orientation.w = 0.761 ;
	...
	desired_pose.pose.position.y = 0.139 ;
	//desired_pose.pose.position.z = 0.2 ;
	desired_pose.pose.position.z = 0.18 ;

	desired_pose.pose.orientation.x = 0.013 ;
	desired_pose.pose.orientation.y = -0.015 ;
	desired_pose.pose.orientation.z = 0.641 ;
	desired_pose.pose.orientation.w = 0.768 ;
...
int main(int argc, char **argv)
{
  ...
  ROS_INFO("Ready to PICK UP 1 Task");
